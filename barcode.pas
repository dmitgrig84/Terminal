...
type
  ...
  TBarcodeOption = (bcoNone, bcoCode, bcoTyp, bcoBoth, bcoCodeBottom); // Type of text to show
	...
	begin
		...
		if FShowText in [bcoTyp, bcoBoth] then
			TextOut(FLeft, FTop+14, GetTypText); {type/name of barcode}
                if FShowText in [bcoCodeBottom] then
			TextOut(FLeft+6, FTop+FHeight-6, FText);
	end;
end;
